# 3.3 AndroidTriviaNavigation :video_game:

## Descripcion
En este repositorio encontraremos el proyecto final de la aplicacion, en la cuañ se ha desarrollado un pequeño quiz sobre Android. Se ha hecho uso de la herramienta de Jetpach Compose para la navegacion entre las diferentes pantallas, ademas de que cada una de ellas ha sido desarrollada mediantes fragmentos. 

Para una navegacion mas fluida se hace uso de botones en la parte inferior de la pantalla, ademas de multiples menus desplegables en la aprte superior de la barra.
